%%
% QPSK, OQPSK Modulation and Demodulation without consideration of noise.
Rb = 2000; Tb = 1/Rb;   % Bit rate 2kbps
fs = 20*Rb;             % Sampling frequency 40kHz
ts = 1/fs;              % Sampling interval
fc = 1.5*Rb;            % Carrier frequency 3kHz

data = [1 1 0 0 1 1 1 0 0 1]; % data
%% QPSK
